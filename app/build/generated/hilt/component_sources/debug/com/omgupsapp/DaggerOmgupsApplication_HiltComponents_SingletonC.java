...
public final class DaggerOmgupsApplication_HiltComponents_SingletonC {
  ...
  private static final class SingletonCImpl extends OmgupsApplication_HiltComponents.SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.omgupsapp.data.DataStoreManager 
          ...
          case 1: // com.omgupsapp.domain.repository.AuthRepository 
          return (T) AppModule_ProvideAuthRepositoryFactory.provideAuthRepository(singletonCImpl.authApiProvider.get(), singletonCImpl.provideDataStoreManagerProvider.get());
